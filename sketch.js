...
function draw() {
  background(135, 229, 234);
  mostraBolinha();
  moveBolinha();
  verificaBordas();
  mostraRaquete(xRaquete, yRaquete);
  moveMinhaRaquete();
  verificaMinhaRaquete();mostraRaquete(xOponente, yOponente);
  movimentaOponente();
  bolinhaNaoFicaPresa();
  incluiPlacar();
  marcaPonto();
...
function bolinhaNaoFicaPresa() {
  if (
    xBolinha - rBolinha < xRaquete &&
    yBolinha - rBolinha < yRaquete + altRaquete &&
...
function verificaMinhaRaquete() {
  if (
    xBolinha - rBolinha < xRaquete + compRaquete &&
    yBolinha - rBolinha < yRaquete + altRaquete &&
    yBolinha + rBolinha > yRaquete
  ) { 
    if (colidiu) {
